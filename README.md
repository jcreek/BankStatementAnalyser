...
To run the project locally with hot reload, use the command `pnpm run dev`.

All linting errors can be automatically fixed (usually) by running `pnpm run lint -- --fix` before you commit your changes.
